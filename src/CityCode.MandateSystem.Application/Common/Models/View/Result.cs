...
namespace CityCode.MandateSystem.Application.Common.Models.View
{
    public class Result<T>
    {
        ...
        internal Result(DateTime requestTime, string errorMessage, string responseCode)
        {
            this.RequestTime = requestTime;
            this.ErrorMessage = errorMessage;
            this.ResponseCode = responseCode;
        ...
        public static Result<T> Success(DateTime requestTime, T value, string responseCode = "00", string? ResponseDescription = null, string? requestId = null) => new(requestTime, value, responseCode, ResponseDescription, requestId);
        ...
        public static Result<T> Failure(DateTime requestTime, string errorMessage, int responseCode) =>
            new(requestTime, errorMessage, responseCode.ToString("00"));
