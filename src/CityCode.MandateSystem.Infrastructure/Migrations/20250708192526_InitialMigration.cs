    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    API_REQUEST_LOG_ID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    API_USER_ID = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    CLIENT_UNIQUE_REQUEST_ID = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    API_END_POINT = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false),
                    API_REQUEST_JSON = table.Column<string>(type: "jsonb", nullable: false),
                    API_REQUEST_DATE = table.Column<DateTime>(type: "date", nullable: false),
                    API_REQUEST_TIME = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    API_RESPONSE_JSON = table.Column<string>(type: "jsonb", nullable: false),
                    API_RESPONSE_DATE = table.Column<DateTime>(type: "date", nullable: true),
                    API_RESPONSE_TIME = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    API_CALL_STATUS = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    ROW_VERSION = table.Column<decimal>(type: "numeric(20,0)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LAST_MODIFIED_BY = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    ...
                    DATE_APPROVED = table.Column<DateOnly>(type: "date", nullable: true),
                    TIME_APPROVED = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    STATUS = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    HASH_VALUE = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true),
                    DELETED_FLAG = table.Column<bool>(type: "bool", nullable: false),
                    DELETED_BY = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    IS_DELETED = table.Column<bool>(type: "boolean", nullable: false),
                    DATE_DELETED = table.Column<DateOnly>(type: "date", nullable: true),
                    TIME_DELETED = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ROW_VERSION = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TO_DO_ITEMS", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TO_DO_ITEMS_TodoLists_ListId",
                        column: x => x.ListId,
